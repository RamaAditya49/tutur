---
name: tutur-bugis
description: Produce, adapt, or review text for Bahasa Bugis with an offline-first regional-language workflow. Use when the user asks for Bahasa Bugis, Bugis regional diction, local-language adaptation, or culturally aware Indonesian-to-Bugis wording without claiming native-level fluency or inventing undocumented vocabulary.
---
...
Use this skill to produce, adapt, or review text related to Bahasa Bugis. Produce usable ordinary-context output from local resources. Mark uncertain wording instead of pretending it is verified.
...
Source confidence: Level 2. Kemdikbud/Balai Bahasa dictionaries, Peta Bahasa Sulawesi Selatan, Glottolog/ISO, ABVD, and politeness references support language identity, short examples, and etiquette cues, but long public or ceremonial text still needs review.

## Search And Discovery

Relevant searches: Bahasa Bugis, kamus Bahasa Bugis, contoh Bahasa Bugis, belajar Bahasa Bugis, terjemahan Indonesia Bugis, translate Bahasa Bugis, bahasa daerah Bugis, AI skill Bahasa Bugis.

Use this skill for source-aware Bahasa Bugis generation and review. It is not a certified translator and must keep dialect, adat, ritual, public, legal, educational, or official text under competent speaker review when uncertain.
...
2. Check source confidence.
   ...
   - Use Bugis dictionaries and politeness references for important word choices.
