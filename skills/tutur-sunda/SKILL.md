---
name: tutur-sunda
description: Produce, adapt, or review text for Bahasa Sunda with an offline-first regional-language workflow. Use when the user asks for Bahasa Sunda, Sunda regional diction, local-language adaptation, or culturally aware Indonesian-to-Sunda wording without claiming native-level fluency or inventing undocumented vocabulary.
---
...
Use this skill to produce, adapt, or review text related to Bahasa Sunda. Produce usable ordinary-context output from local resources. Mark uncertain wording instead of pretending it is verified.
