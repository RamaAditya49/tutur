---
name: tutur-sunda
description: Draft, adapt, or review text for Bahasa Sunda with a cautious regional-language workflow. Use when the user asks for Bahasa Sunda, Sunda regional diction, local-language adaptation, or culturally aware Indonesian-to-Sunda drafting without claiming native-level fluency or inventing undocumented vocabulary.
---
...
Use this skill to adapt, draft, or review text related to Bahasa Sunda. Treat output as a careful draft unless a dictionary, grammar source, or native-speaker sample supports the wording and the requested speech level.
...
2. Check source confidence.
   ...
   - Identify whether the user needs loma, lemes, or another register.
