...
- Rewrite a short Indonesian message with Bahasa Batak Toba flavor.
- Review a Bahasa Batak Toba text for Indonesian interference.
- Create two variants: everyday and more respectful.
- Localize greetings, invitations, and community announcements.
- Make a Horas/Mauliate greeting for a community message.
- Review whether kinship or marga terms are being guessed incorrectly.
...
- Ask for relationship context before using kinship/adat terms.
- Avoid mixing Batak Toba with Karo, Simalungun, Mandailing, Angkola, or Pakpak.
...
- Are kinship terms grounded in user-provided relationship context?
- Are public facts such as schedule, location, price, policy, or safety kept unambiguous?
