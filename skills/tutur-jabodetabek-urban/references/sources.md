...
Level 2: sociolect/register skill. Research supports Jaksel code-mixing and Bekasi/Betawi variation, but individual speech varies by age, class, platform, community, and relationship.

## References

- Tamaddun article on Bahasa Gaul Jaksel, social media, identity, and English loanwords: https://ejournal.ahs-edu.org/index.php/tamaddun/article/view/326
...
- KBBI `ragam bahasa` concept: https://kbbi.web.id/ragam

## Editorial Position

Treat Jaksel/Jaktim/Bekasi as style labels requested by users, not fixed identities. The safe goal is natural urban Indonesian, not caricature.
